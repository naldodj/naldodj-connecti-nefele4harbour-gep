 * Proyecto: GEP
/*
 * Fichero: ChartTotaisGrpMasterVerbasFilial.prg
 * Descripción:
 * Autor:
 * Fecha: 14/08/2021
 */
...
PROCEDURE __ChartTotaisGrpMasterVerbasFilial(oTWebPage,lOpenModal,lSendPage)
    ...
    WITH OBJECT oTWebPage
        ...
        With Object oWBevel0:=WBevel():New(oTWebPage)
            ...
            with object owRTabs:=wRTabs():New(oWBevel0)
               ...
               :cId:="Tabs_ChartTotaisGrpMasterVerbasFilial"
         ...
         for each hRowFil in hDataFil["data"]
             ...
             with object oWbevel:=WBevel():New(oWBevel0)
               ...
               ChartGrpMasterVerbasFilial(oWbevel,hData,codFilial,hRowFil,lOpenModal)
               :create()
             end
...
static function ChartGrpMasterVerbasFilial(oParent,hData,codFilial,hRowFil,lOpenModal)
   ...
   With Object oWBevel0:=WBevel():New(oParent)
              ...
              With Object oWBevel2:=WBevel():New(oWBevel1)
                 ...
                 With Object oWPanel:=WPanel():New(oWBevel2)
                    With Object oWBevel3:=WBevel():New(oWPanel)
                       ...
                       if (lOpenModal)
                          cIDModal:="ChartTotaisGrpMasterVerbasFilial"
                          cIDModal+="_"
       ...
       With Object oWPanel:=WPanel():New(oWBevel0)
                ...
                With Object wChartJS():New(oWPanel)
                    :cType:="bar"
                    :cID:="ChartTotaisGrpMasterVerbasFilial"+codFilial
...
PROCEDURE ChartTotaisGrpMasterVerbasFilial()
   ...
   oCGI:SetUserData("__ChartTotaisGrpMasterVerbasFilial:Back",ProcName())
   ...
   WITH OBJECT wTWebPage():New()
      ...
      GEPParameters(:WO,@cIDParameters,"__ChartTotaisGrpMasterVerbasFilial",aParameters,.T.,cSubTitle,.T.):Create()
