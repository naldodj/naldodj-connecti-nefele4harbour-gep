 * Proyecto: GEP
/*
 * Fichero: ChartTotaisGrpVerbasCentroDeCusto.prg
 * Descripción:
 * Autor:
 * Fecha: 14/08/2021
 */
...
PROCEDURE __ChartTotaisGrpVerbasCentroDeCusto(oTWebPage,lOpenModal,lSendPage)
   ...
   WITH OBJECT oTWebPage
      ...
      with object oWBevel0:=WBevel():New(oTWebPage)
         ...
         with object owRTabs:=wRTabs():New(oWBevel0)
           ...
           :cId:="Tabs_ChartTotaisGrpVerbasCentroDeCusto"
         ...
         for each hRowFil in hDataFil["data"]
          ...
          with object oWbevel:=WBevel():New(oWBevel0)
            ...
            ChartGrpVerbasCentroDeCusto(oWbevel,hData,hDataFil,lOpenModal)
            :create()
          end
...
static function ChartGrpVerbasCentroDeCusto(oParent,hData,hDataFil,lOpenModal)
         ...
         With Object oWBevel0:=WBevel():New(oParent)
                   ...
                   With Object oWPanel:=WPanel():New(oWBevel2)
                      ...
                      With Object oWBevel3:=WBevel():New(oWPanel)
                         ...
                         if (lOpenModal)
                            ...
                            cIDModal:="ChartTotaisGrpVerbasCentroDeCusto"
                            cIDModal+="_"
          ...
          With Object oWPanel:=WPanel():New(oWBevel0)
               ...
               With Object wChartJS():New(oWPanel)
                   :cType:="bar"
                   :cID:="ChartTotaisGrpVerbasCentroDeCusto"+strTran(ckeyProc,".","_")
...
PROCEDURE ChartTotaisGrpVerbasCentroDeCusto()
   ...
   oCGI:SetUserData("__ChartTotaisGrpVerbasCentroDeCusto:Back",ProcName())
   ...
   WITH OBJECT wTWebPage():New()
      ...
      GEPParameters(:WO,@cIDParameters,"__ChartTotaisGrpVerbasCentroDeCusto",aParameters,.T.,cSubTitle,.T.):Create()
